...
object ReadCIFAR10 extends App {
  private val inputStream = getClass.getResourceAsStream("/cifar-10-batches-bin/data_batch_1.bin")
  private val bytes = Array.range(0, 3073).map(_.toByte)
  inputStream.read(bytes)

  private val bufferedImage = new BufferedImage(32, 32, BufferedImage.TYPE_INT_RGB)
